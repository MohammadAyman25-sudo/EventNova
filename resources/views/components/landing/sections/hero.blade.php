<section class="relative pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-purble-900/20 dark:to-gray-900"></div>
    <div class="absolute inset-0 opacity-30">
        <div class="absolute top-20 left-10 w-48 sm:w-72 h-48 sm:h-72 bg-purple-400 rounded-full mix-blend-multiple filter blur-3xl animate-pulse "></div>
        <div class="absolute top-40 right-10 w-48 sm:w-72 h-48 sm:h-72 bg-pink-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
        <div class="absolute bottom-20 left-1/2 w-48 sm:w-72 h-48 sm:h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-2000"></div>
    </div>
