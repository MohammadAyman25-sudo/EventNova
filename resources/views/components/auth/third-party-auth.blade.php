...
<div class="mt-6">
    ...
    <div class="mt-6 grid grid-cols-2 gap-4">
        @foreach ($thirdParties as $thirdParty)
            <a href="{{ route('social.redirect', ['provider'=>strtolower($thirdParty['title']), ]) }}" class="flex items-center justify-center gap-2 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-purple-300 dark:hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all whitespace-nowrap">
